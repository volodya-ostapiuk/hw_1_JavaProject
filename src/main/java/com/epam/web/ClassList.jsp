    ...
    <div class="row">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr style="text-align:center">
                    <td>
                        <c:out value="${class.id}" />
                    </td>
                    <td>
                        <c:out value="${class.name}" />
                    </td>
                    <td>
                        <c:out value="${class.description}" />
                    </td>
                    <td>
                         <c:out value="${class.teacherID}" />
                    </td>
                    <td>
                        <a href="/editclass?id=<c:out value='${class.id}' />">Edit</a>
                        &nbsp;&nbsp;&nbsp;
                        <a href="/deleteclass?id=<c:out value='${class.id}' />">Delete</a>
                    </td>
                </tr>
                </c:forEach>
            </tbody>
